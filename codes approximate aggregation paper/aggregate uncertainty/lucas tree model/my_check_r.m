%This function computes the excess demand (the mean of the asset
%distribution) for a given current price, and a given level of output,
%using the approximate solution to form expectations about future prices.
...
function y  = my_check_r(P,a_grid,zi,Pr,Yg,PrY,c_pol_r,L,Dt,ind_Yg,x,order)
