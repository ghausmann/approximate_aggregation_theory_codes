%This function computes the sequence of variances of the wealth
%distribution over time, given sequences of equilibrium bond prices and
%borrowing limits.
...
function y  = variance_transition(P,T,phi_t,b_grid,ui,Pr,c_pol,D0,qss_ha,x)
